...
Tests are also provided for each operation, located in the [HttpRequestsTest.java](https://github.com/ozhankaraman/spring-boot-api-demo/blob/master/src/test/java/com/github/ozhankaraman/springbootapidemo/HttpRequestsTest.java) file.
